package co.com.app.negocio.mensajes;
...
public class MessagesEstaticos {
	...
	private String existeUsuario = "Ya existe un usuario con la misma identificaci�n!!!";
	...
	private String mensajeErrorGeneracionLiquidacion = "Error Generando volante de Liquidaci�n, no se gener� el consecutivo del volante";
	private String mensajeErrorGeneracionPdf = "Error generando el reporte pdf del volante de liquidaci�n";
	...
	private String mensajeCabeceraInformacion = "Informaci�n";
	...
	private String mensajeVehiculoEstaEnPatio = "El veh�culo con placa %s tiene ingreso al patio %s";
