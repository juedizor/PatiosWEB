package co.com.app.prueba.config;
...
@EnableJpaRepositories(basePackages = {
		"co.com.app.prueba.repository" }, entityManagerFactoryRef = "pruebaEntityManager", transactionManagerRef = "pruebaTransactionManager")
public class PruebaConfigBD {
	...
	public LocalContainerEntityManagerFactoryBean pruebaEntityManager() {
		...
		em.setPackagesToScan(new String[] { "co.com.app.prueba.domain" });
