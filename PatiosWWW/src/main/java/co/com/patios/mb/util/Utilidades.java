...
public class Utilidades {
	...
	/**
	 * obtiene la ruta absoluta del servidor, 
	 * retorna la ruta del war en donde se encuentra el empaquetado de la aplicacion Web
	 * @return
	 */
	...
	public static String obtenerHora(){
	   ...
	   * @param rutaFileName, ruta del archivo
	   */
	 ...
	 * @param rutaDirigir, ruta a la cual se dirigirá al usuario en caso de no estar logueado
	 */
...
//	}
	...
	/**
	 * toma dos valores, los compara con la funcion equals y retorna false en caso que sean diferentes
	 * @param texto1
	 * @param texto2
	 * @return
	 */
